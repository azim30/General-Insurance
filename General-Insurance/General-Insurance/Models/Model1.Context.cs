...
namespace General_Insurance.Models
{
    ...
    public partial class GeneralInsuranceEntities : DbContext
    {
        ...
        public virtual int proc_ApproveMotorClaim(Nullable<int> policyid)
        {
            var policyidParameter = policyid.HasValue ?
                new ObjectParameter("policyid", policyid) :
                new ObjectParameter("policyid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_ApproveMotorClaim", policyidParameter);
        }
    
        public virtual int proc_ApproveTravelClaim(Nullable<int> policyid)
        {
            var policyidParameter = policyid.HasValue ?
                new ObjectParameter("policyid", policyid) :
                new ObjectParameter("policyid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_ApproveTravelClaim", policyidParameter);
        }
        ...
        public virtual ObjectResult<proc_GetAllTravelOfUser_Result> proc_GetAllTravelOfUser(string mobile)
        {
            var mobileParameter = mobile != null ?
                new ObjectParameter("mobile", mobile) :
                new ObjectParameter("mobile", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_GetAllTravelOfUser_Result>("proc_GetAllTravelOfUser", mobileParameter);
        }
